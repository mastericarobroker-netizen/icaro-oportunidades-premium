...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CfeCUyuV.mjs");
...
const manifest = {
  "43a8a8954d4316cf6f20a05d8d6344510e824f94e53a66565d59cc4f5a9313b3": {
    ...
    importer: () => import("./properties.functions-DIVGwMYN.mjs")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BlvtIH7q.mjs"),
    import("./start-CXSb2aW_.mjs"),
